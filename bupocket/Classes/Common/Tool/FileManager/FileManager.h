...
@interface FileManager : BaseModel
 ...
 */
+ (BOOL)createDirectoryAtPath:(NSString *)atPath directoryName:(NSString *)directoryName newFilePath:(NSString *_Nullable*_Nullable)newFilePath;
 ...
 */
+ (BOOL)createFileAtPath:(NSString *)atPath fileName:(NSString *)fileName newFilePath:(NSString *_Nullable*_Nullable)newFilePath;
 ...
 *  @return 成功与否
 */
+ (BOOL)replaceAtPath:(NSString *)atPath intoPath:(NSString *)intoPath newFilePath:(NSString *_Nullable*_Nullable)newFilePath;
 ...
 *  @return 成功与否
 */
+ (BOOL)cutFileAtPath:(NSString *)atPath toDirectoryPath:(NSString *)toDirectoryPath WithFileNewName:(NSString *)newFileName newFilePath:(NSString *_Nullable*_Nullable)newFilePath;
 ...
 *  @return 成功与否
 */
+ (BOOL)copyFileAtPath:(NSString *)atPath toDirectoryPath:(NSString *)toDirectoryPath newFilePath:(NSString *_Nullable*_Nullable)newFilePath;
