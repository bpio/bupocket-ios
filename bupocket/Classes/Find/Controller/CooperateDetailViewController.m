...
- (UIView *)footerView
{
    if (!_footerView) {
        ...
        _signOut = [UIButton createButtonWithTitle:Localized(@"WithdrawalOfSupport") TextFont:FONT_BUTTON TextNormalColor:WHITE_BG_COLOR TextSelectedColor:WHITE_BG_COLOR Target:self Selector:@selector(signOutAction:)];
        _signOut.backgroundColor = CORP_CANCEL_BTN_BG_COLOR;
        ...
        _support = [UIButton createButtonWithTitle:Localized(@"IWantToSupport") TextFont:FONT_BUTTON TextNormalColor:WHITE_BG_COLOR TextSelectedColor:WHITE_BG_COLOR Target:self Selector:@selector(supportAction)];
        ...
        _redemptionAllSupport = [UIButton createButtonWithTitle:Localized(@"RedemptionAllSupport") TextFont:FONT_BUTTON TextNormalColor:WHITE_BG_COLOR TextSelectedColor:WHITE_BG_COLOR Target:self Selector:@selector(signOutAction:)];
        _redemptionAllSupport.backgroundColor = CORP_CANCEL_BTN_BG_COLOR;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            cell.title.textColor = cell.infoTitle.textColor = COLOR_B2;
